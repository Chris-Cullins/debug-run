 ...
 */
export async function installNetcoredbg(onProgress?: (message: string) => void): Promise<string> {
 ...
 */
export async function ensureNetcoredbg(onProgress?: (message: string) => void): Promise<string> {
 ...
 */
export async function installJsDebug(onProgress?: (message: string) => void): Promise<string> {
  const log = onProgress ?? console.log;
  const adaptersDir = getAdaptersDir();
 ...
 */
export async function ensureJsDebug(onProgress?: (message: string) => void): Promise<string> {
